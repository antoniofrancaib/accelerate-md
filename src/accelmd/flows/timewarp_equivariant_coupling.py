"""Timewarp-style E(3)-equivariant coupling layer for PT swap flows.

This module adapts Timewarp's DenseEquivariantShiftModule approach for PT swaps:
...
from .timewarp_flow_base import PTNVPCouplingLayer
from ..flows.mlp import MLP
from .rff_position_encoder import RFFPositionEncoder

__all__ = ["TimewarpEquivariantCouplingLayer"]


class TimewarpEquivariantCouplingLayer(PTNVPCouplingLayer):
    """E(3)-equivariant coupling layer adapted from Timewarp's dense equivariant approach.
    
    This implementation follows Timewarp's design principles:
    ...
    def _compute_equivariant_shifts(
        ...
        Following Timewarp's approach: shift_i = Σ_j c_i * (x_j - x_i)
    ...
    def flow_forward(
        ...
        **kwargs
        ...
        """Forward flow transformation with proper Timewarp-style masking."""
        B, N, _ = coordinates.shape
        device = coordinates.device
        ...
        # CRITICAL: Proper masking following Timewarp exactly
    ...
    def flow_reverse(
        ...
        **kwargs
        ...
        """Reverse flow transformation with proper Timewarp-style masking."""
        B, N, _ = coordinates.shape
        device = coordinates.device
    ...
    def extra_repr(self) -> str:
        ...
        return (
            f"TimewarpEquivariantCouplingLayer(phase={self.phase}, "
