...
#SBATCH -J pt_dataset_AA                 # Job name
...
#SBATCH --output=logs/pt_dataset_AA_%j.out
#SBATCH --error=logs/pt_dataset_AA_%j.err
...
echo "===================================================="
echo "Launching PT dataset builder for AA"
...
stdbuf -oL python -u scripts/build_pt_dataset.py \
  --pdb-dir data/timewarp/2AA-1-big/train \
  --peptides AA \
...
echo "===================================================="
echo "PT dataset generation completed (AA)."
echo "Artefacts saved under data/pt_dipeptides/AA"
